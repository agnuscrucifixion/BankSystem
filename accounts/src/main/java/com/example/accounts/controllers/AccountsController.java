...
public class AccountsController {
    ...
    public ResponseEntity<TransactionDTO> topUpAccount(@RequestHeader(value = "Idempotency-Key", required = false) String idempotencyKey, @PathVariable(value = "accountNumber") Integer accNum, @RequestBody AmountDTO amountDTO) {
